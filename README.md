# ProgressBar 
 This is a html5 element <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/progress">`<progress>`</a> which is created on the page when needed. This is written in vanillaJS,
